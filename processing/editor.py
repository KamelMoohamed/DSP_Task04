...
class Editor:
    ...
    def upload_image(self, path, image_id,counter):
        ...
        img.save_magntiude(os.path.join(dir_path, mag_path))
    ...
    def mix_images(self,counter,commands):
        mag_mask=create_mask(self.shape,commands["mag_shapes"],commands["canvas_dim"],1)
        phase_mask=create_mask(self.shape,commands["phase_shapes"],commands["canvas_dim"],2)
